...
begin
  ...
  Jeweler::Tasks.new do |gem|
    gem.name = "snarl-snp"
    gem.summary = %Q{Snarl Network Protocol Client. You can notify Snarl over LAN.}
    ...
    gem.homepage = "http://github.com/kitamomonga/ruby-snarl-snp"
...
Rake::RDocTask.new do |rdoc|
  ...
  rdoc.rdoc_files.include('HOWTO.rdoc*')
