...
=== Simple Popup (anonymous application)
    ...
    require 'rubygems'
    require 'snarl/snp'
    Snarl::SNP.message(@host, 'title', 'Hello, Snarl!')

or

    Snarl::SNP.new(@host).message('title', 'Hello, Snarl!')
    Snarl::SNP.open(@host){|snp| snp.message('title', 'Hello, Snarl!')}
...
=== Multibyte Popup
    ...
    require 'snarl/snp'
    require 'kconv'
    Snarl::SNP.message(@host, 'タイトル'.tosjis, '日本語'.tosjis)
